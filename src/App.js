...
import SendPrivateMessages from "./pages/SendPrivateMessages";
import "./App.css";
    ...
    <AuthProvider>
      <div>
        ...
        <Routes>
          ...
          <Route path="/send-private-messages" element={<SendPrivateMessages />} />
          <Route path="/send-private-messages/:userId" element={<SendMessage />} />
